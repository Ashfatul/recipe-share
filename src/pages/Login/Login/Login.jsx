        ...
        <div className="container">
            ...
            <Form onSubmit={handleLogin}>
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                    ...
                    <Form.Control type="password" name='password' value={password} onChange={handlePasswordInput} placeholder="Password" required />
                </Form.Group>

                <Button variant="primary" className='w-100 text-uppercase' type="submit">
                    Login
                </Button>
                ...
                <div className="firebase-login">
                    <Button variant="outline-primary" onClick={loginWithGoogle} className='w-100 mb-3 text-uppercase'>
                        Login With Google
                    </Button>
                    <Button variant="outline-primary"  onClick={loginWithGithub} className='w-100 text-uppercase'>
                        Login With GitHub
                    </Button>
                </div>
                <br />
